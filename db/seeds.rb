...
User.destroy_all
u = User.create!(name: "Usuario de Prueba", email: "test@gmail.com", password: "123456")
...
AdminUser.create!(email: 'admin@example.com', password: 'cacacaca', password_confirmation: 'cacacaca') if Rails.env.development?
